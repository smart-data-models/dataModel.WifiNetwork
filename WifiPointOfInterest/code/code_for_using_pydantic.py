...
class Type6(Enum):
    WifiPointOfInterest = 'WifiPointOfInterest'
...
class WifiStatus(Enum):
    ...
    working = 'working'
    workingPartially = 'workingPartially'


class WifiPointOfInterest(BaseModel):
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. it has to be WifiPointOfInterest'
    )
    wifiStatus: Optional[WifiStatus] = Field(
        None,
