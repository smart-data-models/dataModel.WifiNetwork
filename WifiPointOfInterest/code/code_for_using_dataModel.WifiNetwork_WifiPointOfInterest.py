...
dataModel = "WifiPointOfInterest"
subject = "dataModel.WifiNetwork"
timeInstant = "{'type': 'DateTime', 'value': {'@type': 'DateTime', '@value': '2020-09-22T09:30:03.00Z'}}"
attribute = "timeInstant"
value = timeInstant
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

category = {'type': 'Property', 'value': ['70-Servicios de Emergencia']}
attribute = "category"
value = category
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

clientsConnected = {'type': 'Property', 'value': 1563}
